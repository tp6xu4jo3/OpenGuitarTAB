...
assert.match(css, /\.song-browser-artist-rail\s*\{[^}]*grid-template-rows:1fr/s, 'artist rail must stay one row tall');
assert.match(css, /\.artist-filter-avatar\s*\{[^}]*border-radius:50%/s, 'artist filters should be circular');
